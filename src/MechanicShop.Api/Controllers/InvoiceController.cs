...
namespace MechanicShop.Api.Controllers
{
    ...
    public class InvoiceController(ISender sender) : ApiController
    {
        ...
        [Authorize(Policy = "ManagerOnly")]
        [ProducesResponseType(typeof(InvoiceDto), statusCode: StatusCodes.Status200OK)]
        ...
        [MapToApiVersion("1.0")]
        public async Task<IActionResult> IssueInovice(Guid workOrderId, CancellationToken ct)
        {
